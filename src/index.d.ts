// Removed declare module wrapper to make it a proper module
...
export class FFmpegKitConfig {
  ...
  static getSessionsByState(state: any): Promise<Session[]>;

  static getLogRedirectionStrategy(): LogRedirectionStrategy;

  static setLogRedirectionStrategy(
    logRedirectionStrategy: LogRedirectionStrategy
  ): void;

  static messagesInTransmit(sessionId: number): Promise<number>;

  static sessionStateToString(state: any): string;
  ...
  static selectDocumentForRead(
    type?: string,
    extraTypes?: string[]
  ): Promise<string>;

  static selectDocumentForWrite(
    title?: string,
    type?: string,
    extraTypes?: string[]
  ): Promise<string>;
